    ...
    <div class="slider">
      <div class="callbacks_container">
        <ul class="rslides" id="slider">
          <li>
            <img src="front/images/banner1.jpg" class="img-responsive" alt />
          ...
          <li>
            <img src="front/images/banner2.jpg" class="img-responsive" alt />
            <div class="banner_desc">
          ...
          <li>
            <img src="front/images/banner3.jpg" class="img-responsive" alt />
            <div class="banner_desc">
