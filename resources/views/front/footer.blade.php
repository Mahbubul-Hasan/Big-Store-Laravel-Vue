...
<div class="footer">
    <div class="container">
        <div class="col-md-3 f_grid1">
            <h3>About</h3>
            <div class="logo">
                <a href="index.html" style="display: block"><span style="color:red">BIG </span><span style="color:black">STORE</span></a>
            </div>
            <p style="float: left">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
        ...
        <div class="col-md-6 f_grid3">
            ...
            <ul class="list1">
                <li>
                    <p>Aliquam augue a bibendum ipsum diam, semper porttitor libero elit egestas gravida, ut quam,
                        nunc taciti</p>
                </li>
            </ul>
            <div class="clearfix"> </div>
...
<div class="footer_bottom">
    <div class="container">
        ...
        <div class="copy">
            <p>&copy; {{ date("Y") }} Template by <a href="http://w3layouts.com" target="_blank">{{ config("app.name") }}</a></p>
        </div>
        <div class="clearfix"> </div>
    </div>
</div>